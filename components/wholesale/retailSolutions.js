  ...
  const solutions = [
    {
      ...
      icon: "/images/ecommerce-app-icon.png",
    },
    {
    ...
    },
    {
      ...
      icon: "/images/it-systems-icon.png",
    },
    {
  ...
  return (
    <div className=" py-16 px-4 sm:px-6 lg:px-8">
      <div className="container xl:max-w-7xl mx-auto p-4">
        ...
        >
          The retail industry is looking for IT solutions that can help them run their stores more efficiently. Retailers are always looking for new retail solutions that can help them save time and money.
        </motion.p>
        ...
        >
          As a retail store, it is important to have a retail solution that fits your needs. There are many retail solutions available, but not all are created equal. Some retail solutions are better suited for small stores, while others are better for larger stores.
        </motion.p>
        <motion.p 
          className="text-lg mb-8"
          initial={{ opacity: 0 }}
        ...
        >
          {solutions.map((solution, index) => (
            <motion.div
              key={index}
              className="bg-[#FF0000] p-6 border-2 hover:bg-white hover:text-black transition-colors duration-300"
              whileHover={{ y: -5 }}
            >

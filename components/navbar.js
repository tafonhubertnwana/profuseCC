      ...
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6 ml-6">
            ...
            <div className="relative">
              <button
                ...
                className={`${
                  isActive("/tech-services") ? "text-orange-500" : isScrolled ? "text-black" : "text-white"
              ...
              {isServiceDropdownOpen && (
                <div className="absolute mt-2 w-72 bg-white shadow-lg rounded-lg py-2">
                  {[
                    { name: "AWS Cloud Service", href: "/aws-cloud" },
                    { name: "Web Development", href: "/web-development" },
                    { name: "Data & AI", href: "/data-ai" },
                    { name: "SEO & Security", href: "/seo-security" },
                  ].map((service, index) => (
                    <Link
                      key={index}
                      href={service.href}
            ...
            <div className="relative">
              <button
                ...
                className={`${
                  isActive("/why-choose-us") ? "text-orange-500" : isScrolled ? "text-black" : "text-white"
                } hover:text-orange-500 flex items-center relative group`}
              >
                Pages
                <svg
        ...
        <div className="hidden md:flex items-center space-x-6">
          <div className="flex space-x-4">
            ...
            <Link href="https://twitter.com" className={`${isScrolled ? "text-black" : "text-white"} hover:text-orange-500`}>
              <FaXTwitter size={24} />
            </Link>

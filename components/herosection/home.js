...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-[300px] sm:h-[350px] md:h-[400px] lg:h-[550px] xl:h-[700px] overflow-hidden">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
            ...
            {slide.button && (
              <div>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={openModal}
                  className="bg-orange-400 text-white my-4 px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base"
                >
                  {slide.button}
                </motion.button>

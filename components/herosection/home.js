    ...
    <div className="relative h-[350px] sm:h-[350px] md:h-[350px] lg:h-[550px] xl:h-[700px] overflow-hidden">
      ...
      >
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 pt-10 md:pt-20">
          ...
          >
            <motion.h2 className=" uppercase text-white  text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              {slide.h2}
            </motion.h2>
            ...
            {slide.button && (
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={openModal}
                className="bg-orange-400 text-white  my-4  px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-lg "
              >
                {slide.button}
              </motion.button>

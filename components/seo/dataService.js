...
const services = [
  ...
  },
  {
    ...
    icon: <HiOutlineChartBar className="text-3xl text-green-600" />,
  },
  {
    id: 2,
  ...
  return (
    <section className="py-16 px-6 bg-gray-50 text-center">
      ...
      <motion.h3
        ...
        className="text-2xl md:text-3xl font-semibold text-green-600 mt-2"
      >
      ...
      <div className="mt-12 flex flex-col gap-6 items-center">
        {services.map((service) => (
          <motion.div
            ...
            className="max-w-3xl p-6 bg-white shadow-md rounded-xl flex gap-4 items-start border border-gray-200"
          >

...
export default function AwsServices() {
  return (
    <div className="bg-gradient-to-b from-[#0F1C2E] to-[#1B2C44] text-white  p-8">
      <div className="max-w-5xl mx-auto">
        
        <div className="grid grid-cols-2">
          <motion.div>
          <motion.h1 
          className="text-5xl font-bold mt-4 text-orange-300"
        ...
        <motion.button 
          className="mt-6 bg-orange-400 text-black px-6 py-3 rounded-lg font-semibold flex items-center space-x-2 hover:bg-orange-500 transition"
